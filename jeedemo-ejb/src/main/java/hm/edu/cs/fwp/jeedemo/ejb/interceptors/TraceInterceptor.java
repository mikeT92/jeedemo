/*
 * jeedemo-ejb:TraceInterceptor.java
 * Copyright (c) Michael Theis 2017
 */
package hm.edu.cs.fwp.jeedemo.ejb.interceptors;
...
/**
 * EJB based {@code Interceptor} that traces method invocations of EJB methods
 * using a JUL logger named {@code EJBTrace}.
 * <p>
 * Demonstrates the EJB-specific support of interceptors.
 * </p>
 * <p>
 * In order to activate this interceptor just add the following annotation to
 * your EJB class:
 * </p>
 * 
 * <pre>
...
public class TraceInterceptor {
	...
	/**
	 * Proceeds with the intercepted invocation tracing method parameters and return
	 * value plus duration on DEBUG level.
	 */
	...
	/**
	 * Writes a log entry with all information about the called service operation to
	 * the given logger.
	 */
	...
	/**
	 * Writes a log entry with all information about the return value of the called
	 * service operation to the given logger.
	 */
	...
	/**
	 * Writes the return value of the called service operation to the given writer.
	 * Arrays of primitive types are ignored.
	 */
	...
	/**
	 * Appends a default prefix containing the eyecatcher, the class name and the
	 * method name to the specified writer.
	 */
	...
	/**
	 * Ensures that messages exceeding the predefined maximum length are truncated
	 * to avoid OutOfMemoryErrors during logging.
	 */
